...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", type=str,required=True, help="Output directory of this script")
    parser.add_argument("--training_outdir", type=str,required=True, help="Output directory specified in config file.")
...
def main(args):
    ...
    all_era_template["output_path"] = args.training_outdir
